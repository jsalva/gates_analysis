...
'313','314','315','316','317','318','319','320','321','322','323']#,'401','402','403','404','405','406','500','501']
...
#pilot 01 no flanker
info['300']= [(['mprag_wrongprotocol1'],'struct'),(['WM1','WM2','WM3','WM4'],'WM'),(['NBack_199tr1','NBack_199tr2'],'Nback_letters'),([''],'mag'),([''],'phase')]
...
info['302']=[(['mprag2'],'struct'),(['WM1','WM2','WM3','WM4'],'WM'),(['Nback_276tr1','Nback1'],'Nback_letters'),([''],'mag'),([''],'phase')]
#only 1 "good" nback run (second run) first had 204 TR; 
info['303']=[(['mprag2'],'struct'),(['WM1','WM2','WM3','WM4'],'WM'),(['Nback_204tr1','Nback1'],'Nback_letters'),([''],'mag'),([''],'phase')]
...
info['309']=[(['mprag2'],'struct'),(['WM1','WM2','WM3','WM4'],'WM'),(['Nback1','Nback2'],'Nback_letters'),(['fieldmap_func1'],'mag'),(['fieldmap_func2'],'phase')]
info['310']=[(['mprag2'],'struct'),(['WM1','WM2','WM3','WM4'],'WM'),(['Nback1','Nback2'],'Nback_letters'),(['fieldmap_func1'],'mag'),(['fieldmap_func2'],'phase')]
...
info['313']=[(['mprag2'],'struct'),(['WM1','WM2','WM3','WM4'],'WM'),(['Nback1','Nback2'],'Nback_letters'),(['fieldmap_func1'],'mag'),(['fieldmap_func2'],'phase')]
...
info['321']=[(['mprag2'],'struct'),(['WM1','WM2','WM3','WM4'],'WM'),(['Nback1','Nback2'],'Nback_letters'),(['fieldmap_func1'],'mag'),(['fieldmap_func2'],'phase')]
info['322']=[(['mprag2'],'struct'),(['WM1','WM2','WM3','WM4'],'WM'),(['Nback1','Nback2'],'Nback_letters'),(['fieldmap_func1'],'mag'),(['fieldmap_func2'],'phase')]
...
info['326']=[(['mprag2'],'struct'),(['WM5','WM2','WM3','WM4'],'WM'),(['Nback1'],'Nback_letters'),(['fieldmap_func1'],'mag'),(['fieldmap_func2'],'phase')]
info['327']=[(['mprag2'],'struct'),(['WM1','WM2','WM3','WM4'],'WM'),(['Nback1','Nback2'],'Nback_letters'),(['fieldmap_func1'],'mag'),(['fieldmap_func2'],'phase')]
info['328']=[(['mprag2'],'struct'),(['WM1','WM2','WM3','WM4'],'WM'),(['Nback1','Nback2'],'Nback_letters'),(['fieldmap_func1'],'mag'),(['fieldmap_func2'],'phase')]
...
info['501']=[(['mprag2'],'struct'),(['WM1','WM2','WM3','WM4'],'WM'),(['Nback1','Nback2'],'Nback_letters'),(['fieldmap_func1'],'mag'),(['fieldmap_func2'],'phase')]
...
datasink.inputs.base_directory = os.path.join(study_dir, 'l1output_fldmap_nocompcor')
...
l1pipeline = pe.Workflow(name="l1pipeline_fldmap_nocompcor")
...
#                                    ('realigned_files','realigned_files')]),
                    ...
                    (datasource,fieldmap,[('mag','mag_file'),
                                            ('phase','dph_file')]),
                    (fieldmap,calcSurfReg,[('exfdw','source_file')]),
                    #(fieldmap,compcorr,[('exfdw','inputspec.mean_file')]),
                    (fieldmap,ApplyVolTransform,[('exfdw','source_file')]),
                    (fieldmap,dewarper,[('exf_mask','mask_file'),
                                            ('vsm_file','shift_in_file')]),
                    (realign,dewarper,[('realigned_files','in_file')]),
                    (dewarper,art,[('unwarped_file','realigned_files')]),
                    (dewarper,volsmooth,[('unwarped_file','in_files')]),
                    #(dewarper,compcorr,[('unwarped_file','inputspec.realigned_file')]),
...
#                    (compcor,modelspec,[('noise_components','outlier_files')]),#### does this belong here?
                    ...
                    (fieldmap,normflow,[('exfdw','inputspec.mean_func')]),
...
l2datasource.inputs.template = 'l1output_*fldmap/*/norm_func/con_%04d*'
...
l2datasink.inputs.base_directory = os.path.join(study_dir, 'l2output_combined_fldmap_nofldmap/')

l2pipeline = pe.Workflow(name='l2output_combined_fldmap_nofldmap')
