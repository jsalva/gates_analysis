...
'328','329','330','332','333','334','335','336','337']#,
#'328','329','330','332','333','334','335','336','337']#,'333','334','335',
#'401','402','403','404','405','406','407','408','409']#,
#'500','501','502','503','500_2','501_2','502_2','503_2']
...
datasink.inputs.base_directory = os.path.join(study_dir, 'l1sink_allnodes_allresps')
...
l1pipeline = pe.Workflow(name="l1_allnodes_motion_outliers_removed_allresps")
...
l2datasource.inputs.template = 'l1sink_*/*/norm_func/con_%04d*'
...
l2datasink = pe.Node(interface=nio.DataSink(), name="l2sink_kids_allresps")
l2datasink.inputs.base_directory = os.path.join(study_dir, 'l2sink_kids_allresps/')

l2pipeline = pe.Workflow(name='l2_kids_allresps')
