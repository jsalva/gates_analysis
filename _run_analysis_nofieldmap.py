...
def timeseries_design(subject_id,whatParadigm,onsets_dir):
    ...
    regressors = None
    onsets_temp = os.path.join(onsets_dir, subject_id+'_WMrun*onsets_durations.mat')
...
datasink.inputs.base_directory = os.path.join(study_dir, 'l1sink_-fieldmap_durations')
...
l1pipeline = pe.Workflow(name="l1_-fieldmap_motion_outliers_removed_dilated_durations_modeled")
