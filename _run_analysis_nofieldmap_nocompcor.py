...
datasink.inputs.base_directory = os.path.join(study_dir, 'l1output_nofldmap_nocompcor')
...
l1pipeline = pe.Workflow(name="l1pipeline_nofldmap_nocompcor")
...
l2datasource.inputs.base_directory = '/mindhive/gablab/GATES/Analysis/%s/l1output_nofldmap/'%(paradigm)
